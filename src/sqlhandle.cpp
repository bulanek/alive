...
void SqlHandle::createMainTables(){
    ...
    queryReturn=query.exec("create table if not exists INFO_1("
                           ...
                           "rangeSignal_0 INT,"
                           "rangeSignal_1 INT,"
                           "rangeBackground_0 INT,"
                           "rangeBackground_1 INT,"
                           "fadParameter_0 DOUBLE,"
                           "fadParameter_1 DOUBLE,"
                           "eFadParameter_0 DOUBLE,"
                           "eFadParameter_1 DOUBLE,"
                           "fad_cov_0_1 DOUBLE,"
...
void SqlHandle::insertIntoMainInfoTable(const MainWindowData& mainWindowData){
    ...
    _dataHandle=DataHandle::getInstance();
    string execStr=string("insert into INFO_1 (id,name,num_m,IRR_Power,rangeSignal_0,rangeSignal_1,rangeBackground_0,rangeBackground_1,fadParameter_0,fadParameter_1,eFadParameter_0,eFadParameter_1,fad_cov_0_1) values (")
            ...
            +TOOLS::convertToString(mainWindowData.rangeSignal[0])+","
            +TOOLS::convertToString(mainWindowData.rangeSignal[1])+","
            +TOOLS::convertToString(mainWindowData.rangeBackground[0])+","
            +TOOLS::convertToString(mainWindowData.rangeBackground[1])+","
            +TOOLS::convertToString(mainWindowData.fadParameters[0])+","
            +TOOLS::convertToString(mainWindowData.fadParameters[1])+","
            +TOOLS::convertToString(mainWindowData.eFadParameters[0])+","
            +TOOLS::convertToString(mainWindowData.eFadParameters[1])+","
            +TOOLS::convertToString(mainWindowData.fad_cov_0_1)
            +");";
    QSqlQuery query;
...
const vector<Data> SqlHandle::getSqlData(const int ID){
    ...
    queryReturn=q.exec("select id,name,IRR_Power,rangeSignal_0,rangeSignal_1,rangeBackground_0,rangeBackground_1,fadParameter_0,fadParameter_1,eFadParameter_0,eFadParameter_1,fad_cov_0_1 from INFO_1;");
    if (!queryReturn){
        qDebug()<<q.lastQuery();
    ...
    mainData.rangeSignal[0]=q.value(3).toDouble();
    mainData.rangeSignal[1]=q.value(4).toDouble();
    mainData.rangeBackground[0]=q.value(5).toDouble();
    mainData.rangeBackground[1]=q.value(6).toDouble();
    mainData.fadParameters[0]=q.value(7).toDouble();
    mainData.fadParameters[1]=q.value(8).toDouble();
    mainData.eFadParameters[0]=q.value(9).toDouble();
    mainData.eFadParameters[1]=q.value(10).toDouble();
    mainData.fad_cov_0_1=q.value(11).toDouble();
